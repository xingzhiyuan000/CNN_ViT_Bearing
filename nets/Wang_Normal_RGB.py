...
# 搭建神经网络
class Wang_Normal_RGB(nn.Module):
    def __init__(self):
        super(Wang_Normal_RGB, self).__init__()
        # 1X10X10------32X10X10
        # self.conv1 = nn.Conv2d(in_channels=1, out_channels=32, kernel_size=3, stride=1, padding=1) #普通3X3卷积
        self.conv1 =nn.Conv2d(in_channels=3, out_channels=32, kernel_size=3, stride=1, padding=1) #普通3X3卷积
        self.bn1 = nn.BatchNorm2d(num_features=32)
        # 32X10X10------32X5X5
        self.pool1 = nn.MaxPool2d(kernel_size=2)
        # 32X5X5------32X3X3
        self.conv2 =nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3, stride=1, padding=1) #普通3X3卷积
        ...
        # 128X5X5------256X5X5
        self.conv5 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1) #普通3X3卷积
        self.bn5 = nn.BatchNorm2d(num_features=256)
        # 256X5X5------128X5X5
        self.conv6 = nn.Conv2d(in_channels=256, out_channels=128, kernel_size=3, stride=1, padding=1) #普通3X3卷积
        self.bn6 = nn.BatchNorm2d(num_features=128)
        # 128X5X5------64X5X5
        self.conv7 = nn.Conv2d(in_channels=128, out_channels=64, kernel_size=3, stride=1, padding=1) #普通3X3卷积
